...
def main():
    ...
    for entry in lvm_entries:
        ...
        if partition_file:
            write_partition_image(entry, lvm_image, partition_file)
        else:
