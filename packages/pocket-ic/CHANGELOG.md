...
- The function `PocketIcBuilder::with_all_icp_features` to specify that all system canisters (registry etc.) should be bootstrapped
  and kept in sync with the PocketIC instance.
