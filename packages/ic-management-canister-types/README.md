...
[1]: https://docs.internetcomputer.org/references/management-canister/#management-canister
...
The [`ic.did`](tests/ic.did) is sourced from the [Internet Computer Interface Specification](https://docs.internetcomputer.org/references/management-canister/#candid).
