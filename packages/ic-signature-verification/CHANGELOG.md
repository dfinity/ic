...
## [0.3.0] - Not Yet Relesed

### Changed

- Extended verification of certificates to support the new sharded canister ranges syntax
  introduced in the 0.50.0 revision of the Internet Computer specification.
