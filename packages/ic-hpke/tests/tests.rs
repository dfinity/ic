...
fn key_generation_and_noauth_encrypt_is_stable() {
    ...
    assert_eq!(hex::encode(sk_bytes), "64e4f9efb76abc01ca9b347c733a5375e97fb372763bd3b3478fce3ab7c7c340521d410051eff1c5cea6efa33cbf0910b919730726c42397");

    let pk = sk.public_key();
    let pk_bytes = pk.serialize();
    assert_eq!(pk_bytes.len(), 105);
    assert_eq!(hex::encode(pk_bytes), "64e4f9efb76abc01041e0fff52d0cb05f440c47614c50c2ace65db74194fc85fc55345140a9543bf1228dab6f0e4254505c7eaf692f7d8478eb8f027d944acc65d2c6818101b55a28861abc6386e6c85ded766e48e211253184ccaf7243685fe7ac36526a9ac7a4311");
    ...
    assert_eq!(hex::encode(ctext), "");
}
...
fn key_generation_and_authticated_encrypt_is_stable() {
    ...
    assert_eq!(hex::encode(&ctext_b_to_a), "");

    assert_eq!(hex::encode(&ctext_a_to_b), "");
}
