...
function process_bootstrap() {
    ...
    for FILE in filebeat.conf network.conf remuneration.conf nns.conf backup.conf malicious_behavior.conf query_stats.conf bitcoind_addr.conf jaeger_addr.conf socks_proxy.conf; do
