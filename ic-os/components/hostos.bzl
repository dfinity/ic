...
component_files = {
    ...
    Label("hostos/misc/rbash/bash"): "/opt/ic/bin/rbash/bash",
    Label("hostos/misc/rbash/deny"): "/opt/ic/bin/rbash/deny",
    Label("hostos/misc/rbash/rbash-shadow.list"): "/opt/ic/share/rbash-shadow.list",
