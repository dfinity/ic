...
component_files = {
    ...
    Label("hostos-scripts/guestos/upgrade-guestos.service"): "/etc/systemd/system/upgrade-guestos.service",
    ...
    Label("ssh/setup-ssh-user-keys/setup-ssh-user-keys-hostos.sh"): "/opt/ic/bin/setup-ssh-user-keys-hostos.sh",
