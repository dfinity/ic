...
component_files = {
    ...
    Label("//ic-os/components/hostos/misc:setup-var.sh"): "/opt/ic/bin/setup-var.sh",
    Label("//ic-os/components/hostos/misc:detect-first-boot.sh"): "/opt/ic/bin/detect-first-boot.sh",
    ...
    Label("//ic-os/components/hostos/misc:grub-upgrader/grub-upgrader.sh"): "/opt/ic/bin/grub-upgrader.sh",
    Label("//ic-os/components/hostos/misc:grub-upgrader/grub-upgrader.service"): "/etc/systemd/system/grub-upgrader.service",
    Label("//ic-os/components/hostos/misc:logrotate/override.conf"): "/etc/systemd/system/logrotate.service.d/override.conf",
    ...
    Label("//cpp:infogetty"): "/opt/ic/bin/infogetty:0755",
    ...
    Label("//ic-os/components/hostos/misc:sudoers"): "/etc/sudoers",
    Label("//ic-os/components/hostos/misc:limited-console-shell"): "/opt/ic/bin/limited-console-shell:0755",
    Label("//ic-os/components/hostos/misc:ic-node.conf"): "/etc/tmpfiles.d/ic-node.conf",
    Label("//ic-os/components/hostos/misc:20-ipmi.rules"): "/etc/udev/rules.d/20-ipmi.rules",
