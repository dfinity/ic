...
component_files = {
    ...
    Label("ic/ic-doge-adapter/generate-doge-adapter-config.sh"): "/opt/ic/bin/generate-doge-adapter-config.sh",
    Label("ic/ic-doge-adapter/ic-doge-mainnet-adapter.service"): "/etc/systemd/system/ic-doge-mainnet-adapter.service",
    Label("ic/ic-doge-adapter/ic-doge-mainnet-adapter.socket"): "/etc/systemd/system/ic-doge-mainnet-adapter.socket",
    Label("ic/ic-doge-adapter/ic-doge-testnet-adapter.service"): "/etc/systemd/system/ic-doge-testnet-adapter.service",
    Label("ic/ic-doge-adapter/ic-doge-testnet-adapter.socket"): "/etc/systemd/system/ic-doge-testnet-adapter.socket",
