...
def component_files(mode):
    return {
        ...
        Label("monitoring/guestos/fstrim/fstrim_metrics.service"): "/etc/systemd/system/fstrim_metrics.service",
        Label("monitoring/guestos/fstrim/fstrim_metrics.timer"): "/etc/systemd/system/fstrim_metrics.timer",
