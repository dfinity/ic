...
component_files = {
    ...
    Label("guestos/monitoring/setup-node-gen-status.service"): "/etc/systemd/system/setup-node-gen-status.service",
    Label("guestos/monitoring/nft-exporter/nft-exporter.service"): "/etc/systemd/system/nft-exporter.service",
    Label("guestos/monitoring/nft-exporter/nft-exporter.timer"): "/etc/systemd/system/nft-exporter.timer",
    ...
    Label("guestos/monitoring/metrics_tool.service"): "/etc/systemd/system/metrics_tool.service",
    Label("guestos/monitoring/metrics_tool.timer"): "/etc/systemd/system/metrics_tool.timer",
