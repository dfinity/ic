            ...
            native.genrule(
                ...
                cmd = r"""
                    ...
                    (for cmdline in "$$BOOT_ARGS_A" "$$BOOT_ARGS_B"; do
                        hex=$$(/home/ubuntu/.local/bin/sev-snp-measure --mode snp --vcpus 64 --ovmf "$(location //ic-os/components/ovmf:ovmf_sev)" --vcpu-type=EPYC-v4 --append "$$cmdline" --initrd "$(location extracted_initrd.img)" --kernel "$(location extracted_vmlinuz)")
