...
The GuestOS firewall can be altered by operators to suit their needs.
Please consult link:../docs/Network-Configuration.adoc[the documentation for network configuration] for more information.
