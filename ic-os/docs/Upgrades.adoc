...
Following the execution of these commands, the system will reboot into the newly
installed version. The newly booted slot remains in a probationary
+first_boot+ state until GuestOS/HostOS explicitly confirms it with:
