...
def launch_bare_metal(name, image_zst_file):
    ...
    native.sh_binary(
        ...
        data = [":" + binary_name, image_zst_file, "//rs/ic_os/setupos-inject-configuration", "@python_deps_idracredfishsupport//:IdracRedfishSupport-0.0.8.data/scripts/VirtualDiskExpansionREDFISH.py"],
        tags = ["manual"],
    )
