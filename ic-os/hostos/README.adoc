...
However, operators can alter the firewall rules in their deployment -- please see
link:../docs/Network-Configuration.adoc[the documentation for network configuration] for more information.

Please find the default raw HostOS NFTables ruleset in `nftables.conf`
