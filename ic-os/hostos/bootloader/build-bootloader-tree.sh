...
# NOTE: This file duplicates `ic-os/bootloader/build-bootloader-tree.sh`, with
# a small change to include `lvm` in the initial modules. This duplication
# will be cleaned up when moving HostOS to bazel builds, with NODE-465.
