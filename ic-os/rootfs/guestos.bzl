...
rootfs_files = {
    ...
    Label("prep/guestos/filebeat/filebeat.if"): "/prep/filebeat/filebeat.if",
    Label("prep/guestos/filebeat/filebeat.te"): "/prep/filebeat/filebeat.te",
    Label("prep/guestos/manageboot/manageboot.fc"): "/prep/manageboot/manageboot.fc",
    Label("prep/guestos/manageboot/manageboot.if"): "/prep/manageboot/manageboot.if",
    Label("prep/guestos/manageboot/manageboot.te"): "/prep/manageboot/manageboot.te",
    Label("prep/guestos/fscontext-fixes/fscontext-fixes.fc"): "/prep/fscontext-fixes/fscontext-fixes.fc",
    Label("prep/guestos/fscontext-fixes/fscontext-fixes.if"): "/prep/fscontext-fixes/fscontext-fixes.if",
    Label("prep/guestos/fscontext-fixes/fscontext-fixes.te"): "/prep/fscontext-fixes/fscontext-fixes.te",
    Label("prep/guestos/ic-node/ic-node.fc"): "/prep/ic-node/ic-node.fc",
    Label("prep/guestos/ic-node/ic-node.if"): "/prep/ic-node/ic-node.if",
    Label("prep/guestos/ic-node/ic-node.te"): "/prep/ic-node/ic-node.te",
    Label("prep/guestos/infogetty/infogetty.fc"): "/prep/infogetty/infogetty.fc",
    Label("prep/guestos/infogetty/infogetty.te"): "/prep/infogetty/infogetty.te",
    Label("prep/guestos/misc-fixes/misc-fixes.if"): "/prep/misc-fixes/misc-fixes.if",
    Label("prep/guestos/misc-fixes/misc-fixes.te"): "/prep/misc-fixes/misc-fixes.te",
    Label("prep/guestos/node_exporter/node_exporter.fc"): "/prep/node_exporter/node_exporter.fc",
    Label("prep/guestos/node_exporter/node_exporter.if"): "/prep/node_exporter/node_exporter.if",
    Label("prep/guestos/node_exporter/node_exporter.te"): "/prep/node_exporter/node_exporter.te",
    Label("prep/guestos/prep.sh"): "/prep/prep.sh",
    Label("prep/guestos/setup-var/setup-var.if"): "/prep/setup-var/setup-var.if",
    Label("prep/guestos/setup-var/setup-var.te"): "/prep/setup-var/setup-var.te",
    Label("prep/guestos/systemd-fixes/systemd-fixes.if"): "/prep/systemd-fixes/systemd-fixes.if",
    Label("prep/guestos/systemd-fixes/systemd-fixes.te"): "/prep/systemd-fixes/systemd-fixes.te",
