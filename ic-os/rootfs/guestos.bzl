...
rootfs_files = {
    ...
    Label("utils/provision-ssh-keys.sh"): "/opt/ic/bin/provision-ssh-keys.sh",
    ...
    Label("setup-ssh-keys/setup-ssh-keys.sh"): "/opt/ic/bin/setup-ssh-keys.sh",
    Label("setup-ssh-keys/setup-ssh-keys.service"): "/etc/systemd/system/setup-ssh-keys.service",
