...
rootfs_files = {
    ...
    Label("upgrade-shared-data-store/upgrade-shared-data-store.sh"): "/opt/ic/bin/upgrade-shared-data-store.sh",
    Label("upgrade-shared-data-store/upgrade-shared-data-store.service"): "/etc/systemd/system/upgrade-shared-data-store.service",
    ...
    Label("setup-shared-resources/setup-shared-backup.sh"): "/opt/ic/bin/setup-shared-backup.sh",
    Label("setup-shared-resources/setup-shared-backup.service"): "/etc/systemd/system/setup-shared-backup.service",
    Label("setup-shared-resources/setup-shared-crypto.sh"): "/opt/ic/bin/setup-shared-crypto.sh",
    Label("setup-shared-resources/setup-shared-crypto.service"): "/etc/systemd/system/setup-shared-crypto.service",
    Label("setup-shared-resources/setup-shared-data.sh"): "/opt/ic/bin/setup-shared-data.sh",
    Label("setup-shared-resources/setup-shared-data.service"): "/etc/systemd/system/setup-shared-data.service",
    Label("generate-config/generate-btc-adapter-config.sh"): "/opt/ic/bin/generate-btc-adapter-config.sh",
