...
The https://gitlab.com/dfinity-lab/public/ic/-/tree/master/rs/boundary_node/prober[Prober^] service performs periodical functionality checks against the various IC subnets.
