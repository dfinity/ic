...
This creates a Bazel repository which exports 'mainnet_versions'. This macro can be
called to create one Bazel repository for the entire mainnet versions list.
"""

def _mainnet_versions_impl(repository_ctx):
...
mainnet_versions = repository_rule(
    ...
    attrs = {
        "path": attr.label(mandatory = True, doc = "path to mainnet versions data"),
    },
)
