...
def foo(name, actual, tags):
    if name == "axum-0.6.20": # sigh
        return native.alias(name = "axum_0_6_1", actual = actual, tags = tags)
    if name == "axum-0.7.4":
        return native.alias(name = "axum", actual = actual, tags = tags)
    if name == "bs58-0.5.0":
        return native.alias(name = "bs58", actual = actual, tags = tags)
    if name == "clap-3.2.25":
        return native.alias(name = "clap_3_2_25", actual = actual, tags = tags)
    if name == "clap-4.4.8":
        return native.alias(name = "clap", actual = actual, tags = tags)
    if name == "http-0.2.12":
        return native.alias(name = "http_0_2_12", actual = actual, tags = tags)
    if name == "http-1.1.0":
        return native.alias(name = "http", actual = actual, tags = tags)
    if name == "http-body-0.4.6":
        return native.alias(name = "http_body_0_4_6", actual = actual, tags = tags)
    if name == "http-body-1.0.0":
        return native.alias(name = "http-body", actual = actual, tags = tags)
    if name == "hyper-0.14.27":
        return native.alias(name = "hyper_0_14_27", actual = actual, tags = tags)
    if name == "hyper-1.3.1":
    ...
    if name == "hyper-rustls-0.27.1":
        return native.alias(name = "hyper_rustls_0_27_x", actual = actual, tags = tags)
    if name == "ic0-0.21.1":
        return native.alias(name = "ic0", actual = actual, tags = tags)
    if name == "opentelemetry-0.20.0":
        return native.alias(name = "opentelemetry_0_20_0", actual = actual, tags = tags)
    if name == "opentelemetry-0.23.0":
        return native.alias(name = "opentelemetry", actual = actual, tags = tags)
    if name == "opentelemetry-prometheus-0.13.0":
        return native.alias(name = "opentelemetry_prometheus_0_13_0", actual = actual, tags = tags)
    if name == "opentelemetry-prometheus-0.16.0":
        return native.alias(name = "opentelemetry-prometheus", actual = actual, tags = tags)
    if name == "rand_chacha-0.4.19":
        return native.alias(name = "rand_chacha_0_4_19", actual = actual, tags = tags)
    if name == "reqwest-0.11.27":
        return native.alias(name = "reqwest_0_11_27", actual = actual, tags = tags)
    ...
    if name == "rustls-0.21.12":
        return native.alias(name = "rustls_0_21_12", actual = actual, tags = tags)
    if name == "rustls-0.23.8":
        return native.alias(name = "rustls", actual = actual, tags = tags)
    if name == "sha2-0.9.9": # sigh
        return native.alias(name = "sha2_0_9_1", actual = actual, tags = tags)
    if name == "sha2-0.10.8":
        return native.alias(name = "sha2", actual = actual, tags = tags)
    if name == "tokio-rustls-0.26.0":
        return native.alias(name = "tokio_rustls_0_24_1", actual = actual, tags = tags)
    if name == "tokio-rustls-0.26.0":
        return native.alias(name = "tokio-rustls", actual = actual, tags = tags)
    if name == "tower-http-0.4.4":
        return native.alias(name = "tower_http_0_4_4", actual = actual, tags = tags)
