...
load("//rs/tests:common.bzl", "MAINNET_APP_GUESTOS_REVISION", "MAINNET_LATEST_GUESTOS_REVISION", "MAINNET_LATEST_HOSTOS_REVISION", "MAINNET_NNS_GUESTOS_REVISION")
...
def mainnet_icos_images():
    ...
    http_file(
        name = "mainnet_latest_guestos_dev_update_image",
        downloaded_file_path = "update-img.tar.zst",
    ...
    http_file(
        name = "mainnet_app_setupos_disk_image",
        downloaded_file_path = "disk-img.tar.zst",
        url = base_download_url(MAINNET_APP_GUESTOS_REVISION, "setup-os", False, False),
    )

    http_file(
        name = "mainnet_app_setupos_dev_disk_image",
        downloaded_file_path = "disk-img.tar.zst",
        url = dev_base_download_url(MAINNET_APP_GUESTOS_REVISION, "setup-os", False),
    )
