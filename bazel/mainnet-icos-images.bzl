...
load("//rs/tests:common.bzl", "MAINNET_LATEST_HOSTOS_REVISION", "MAINNET_NNS_GUESTOS_REVISION")
...
def mainnet_icos_images():
    ...
    http_file(
        ...
        downloaded_file_path = "disk-img.tar.zst",
        url = dev_base_download_url(MAINNET_LATEST_HOSTOS_REVISION, "setup-os", False) + "disk-img.tar.zst",
    )
