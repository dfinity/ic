...
2. OVERRIDE_DIDC_CHECK: Skips didc check.
""".strip()
)
...
OVERRIDE_DIDC_CHECK environment variable is set to "true".
""".strip(),
)
...
def main(argv):
    ...
    override_didc_check = override_didc_check_string in os.environ.get("OVERRIDE_DIDC_CHECK", "")
    ...
    override_also_reverse = override_also_reverse_string in os.environ.get("OVERRIDE_DIDC_CHECK", "")
