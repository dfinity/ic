...
IGNORE_LIST_BY_PROJECT = {
    "OSP: ic/ic-os/boundary-guestos/envs/prod": resource_reader.read_ignore_list(IgnoreList.BOUNDARY_GUEST_OS),
    "OSP: ic/ic-os/guestos/envs/prod": resource_reader.read_ignore_list(IgnoreList.GUEST_OS),
}
