...
Thank you for your interest in contributing to the Internet Computer Protocol. If you'd like to contribute a feature or bug fix, please **reach out to us first** so that we can discuss feasibility and implementation strategies. You can reach out to us:
* on the [forum](https://forum.dfinity.org/), or
* 
...
1. You will be notified that CI has been kicked off with a link the CI run via a comment. Once CI is complete, it will report the status back to your PR.
