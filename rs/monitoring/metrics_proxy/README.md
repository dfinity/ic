...
> This crate was vendored into the IC monorepo from the (now deprecated)
> [`dfinity/metrics-proxy`](https://github.com/dfinity/metrics-proxy) repository.
> Please make changes here rather than in the upstream repository.
