...
use crate::canister_http::CanisterHttpResponseReceiptShare;
use crate::consensus::{
...
mod private {
    ...
    impl SignatureDomainSeal for CanisterHttpResponseReceiptShare {}
...
impl SignatureDomain for CanisterHttpResponseReceiptShare {
    fn domain(&self) -> Vec<u8> {
