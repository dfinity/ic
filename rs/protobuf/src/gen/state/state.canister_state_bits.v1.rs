...
pub struct CanisterStateBits {
    ...
    /// introduced, so unlike the scalar `consumed_cycles` above they are not the
    /// canister's full history. HTTPS outcalls have no entry here: they are only
    /// tracked as a gauge at the subnet level.
    ...
    /// they cover as much as those gauges do, i.e. everything consumed since March
    ...
    /// The minimum number of cycles required for an incoming call from a different canister.
