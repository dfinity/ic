...
pub struct CanisterStateBits {
    ...
    /// backfilled from here, so these are the amounts that are guaranteed to hold
    /// the canister's full history. HTTPS outcalls have no entry here: they are
    ...
    /// they cover the canister's full history too.
    ///
