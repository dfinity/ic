...
import_mod!("log", replica_config, v1);
import_mod!("log", consensus_log_entry, v1);
import_mod!("log", crypto_log_entry, v1);
import_mod!("log", p2p_log_entry, v1);
import_mod!("log", messaging_log_entry, v1);
import_mod!("log", ingress_message_log_entry, v1);
import_mod!("log", block_log_entry, v1);
import_mod!("log", malicious_behaviour_log_entry, v1);

import_mod!("log", log_entry, v1, {
