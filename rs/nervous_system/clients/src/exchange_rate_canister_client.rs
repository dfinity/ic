        ...
        match self {
            GetExchangeRateError::Xrc(error) => match error {
                ExchangeRateError::AnonymousPrincipalNotAllowed => {
                    write!(f, "Anonymous calls are not allowed")
                }
                ExchangeRateError::Pending => {
                    write!(f, "A similar request is already being processed")
                }
                ...
                ExchangeRateError::StablecoinRateZeroRate => {
                    write!(f, "Stablecoin rate is zero, cannot determine a valid rate")
                }
                ...
                ExchangeRateError::NotEnoughCycles => {
                    write!(f, "Not enough cycles attached to the request")
                }
...
pub struct RealExchangeRateCanisterClient {
    callee_canister_id: CanisterId,
}

impl RealExchangeRateCanisterClient {
    pub fn new(callee_canister_id: CanisterId) -> Self {
        Self { callee_canister_id }
    }
}
