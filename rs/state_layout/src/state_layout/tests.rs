...
/// The field is absent in checkpoints written before it was introduced; it decodes
/// as zero, which is what the by-use-case map did when it was introduced.
#[test]
fn test_decode_missing_consumed_cycles_monotonic() {
    let canister_state_bits = CanisterStateBits {
        consumed_cycles: NominalCycles::new(1000),
        consumed_cycles_monotonic: NominalCycles::new(900),
        ..default_canister_state_bits()
