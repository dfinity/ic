...
. The user calls the link:https://sepolia.etherscan.io/address/0x674Cdbe64Df412DA9bAb1596e00c1520979B5A23#writeContract[minter helper contract] `deposit` method of the helper smart contract (just as `approve` this method can be called from contract's Etherscan page) specifying
