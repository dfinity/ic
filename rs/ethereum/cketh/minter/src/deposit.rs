use crate::eth_rpc_client::rpc_client_builder;
use crate::{
    eth_logs::{
    ...
    S: LogScraping,
{
    ...
    let rpc_client = read_state(rpc_client_builder)
        .with_response_size_estimate(
            HEADER_SIZE_LIMIT + ETH_GET_LOGS_INITIAL_RESPONSE_SIZE_ESTIMATE,
        )
        .build();
    ...
    S: LogScraping,
{
    ...
    while !subranges.is_empty() {
        ...
        let result = rpc_client
            ...
            // TODO XC-508: Once https://github.com/dfinity/evm-rpc-canister/pull/493 merged
