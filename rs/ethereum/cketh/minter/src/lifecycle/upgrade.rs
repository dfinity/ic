...
pub struct UpgradeArg {
    #[cbor(n(0), with = "ic_cross_chain_cbor::nat::option")]
    pub next_transaction_nonce: Option<Nat>,
    #[cbor(n(1), with = "ic_cross_chain_cbor::nat::option")]
