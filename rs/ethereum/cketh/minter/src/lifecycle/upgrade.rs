...
pub struct UpgradeArg {
    #[cbor(n(0), with = "icrc_cbor_u256::nat::option")]
    pub next_transaction_nonce: Option<Nat>,
    #[cbor(n(1), with = "icrc_cbor_u256::nat::option")]
