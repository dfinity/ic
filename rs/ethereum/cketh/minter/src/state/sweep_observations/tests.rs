...
fn should_report_the_age_of_the_last_completed_pass() {
    ...
    observations.record_balance_scan_pass(ts(1_000), &ScanErrors::default());
    ...
    observations.record_balance_scan_pass(ts(4_000), &ScanErrors::default());
...
fn should_accumulate_balance_scan_errors_across_passes() {
    ...
    observations.record_balance_scan_pass(ts(1_000), &errors(2, 1));
    observations.record_balance_scan_pass(ts(2_000), &errors(0, 3));
...
fn should_saturate_rather_than_overflow_the_counters() {
    ...
    observations.record_untracked_delegations(1);
    observations.record_balance_scan_pass(ts(1_000), &errors(u64::MAX, u64::MAX));
    observations.record_balance_scan_pass(ts(2_000), &errors(1, 1));
