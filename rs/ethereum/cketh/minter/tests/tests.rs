...
use ic_cketh_minter::endpoints::{
    CandidBlockTag, Eip1559TransactionPrice, EthTransaction, GasFeeEstimate, MinterInfo,
    RetrieveEthRequest, RetrieveEthStatus, RetrieveEthStatus::Pending, TxFinalizedStatus,
