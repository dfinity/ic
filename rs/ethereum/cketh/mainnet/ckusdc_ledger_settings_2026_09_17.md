# Proposal to change the memory allocation of the ckUSDC ledger canister

Target canister: `xevnm-gaaaa-aaaar-qafnq-cai`

New memory allocation: `10_737_418_240`

Previous ckUSDC ledger proposal: https://dashboard.internetcomputer.org/proposal/143937

---

## Motivation
Set the `memory_allocation` of the ckUSDC ledger canister from its current value of `0` (best-effort) to `10_737_418_240` (10 GiB). The current value can be obtained by calling the [`canister_status`](https://dashboard.internetcomputer.org/canister/r7inp-6aaaa-aaaaa-aaabq-cai#canister_status) endpoint of the NNS root canister.
