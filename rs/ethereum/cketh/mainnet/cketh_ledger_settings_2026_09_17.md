# Proposal to change the memory allocation of the ckETH ledger canister

Target canister: `ss2fx-dyaaa-aaaar-qacoq-cai`

New memory allocation: `10_737_418_240`

Previous ckETH ledger proposal: https://dashboard.internetcomputer.org/proposal/143929
