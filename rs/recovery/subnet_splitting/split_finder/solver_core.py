...
def solve_partition(load_c: List[float],
                    ...
                    epsilon_secondary: float | None = None) -> Dict:
    """
    ...
    if load_secondary is not None and target_sec_0 is not None and target_sec_1 is not None and epsilon_secondary is not None:
