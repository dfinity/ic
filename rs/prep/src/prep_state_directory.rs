...
mod tests {
    ...
    fn init_ic() -> Result<(TempDir, IcPrepStateDir)> {
        ...
        let ic_config = IcConfig::new(
            ...
            /* initial_release_package_download_url= */ None,
            /* initial_release_package_sha256_hex */ None,
            /* initial_release_guest_launch_measurements */ None,
            /* initial_unassigned_nodes_release_version_id */ None,
            /* initial_unassigned_nodes_release_package_url */ None,
            /* initial_unassigned_nodes_release_package_sha256_hex */ None,
            /* initial_unassigned_nodes_release_guest_launch_measurements */ None,
