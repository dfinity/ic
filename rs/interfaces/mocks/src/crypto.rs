...
mockall::mock! {
    pub Crypto {
        ...
        pub fn sign_basic_upgrade_permit_auth(
            &self, message: &UpgradePermitAuthorizationContent,
        ) -> CryptoResult<BasicSigOf<UpgradePermitAuthorizationContent>>;
        ...
        pub fn verify_basic_sig_upgrade_permit_auth(
            &self,
            signature: &BasicSigOf<UpgradePermitAuthorizationContent>,
            message: &UpgradePermitAuthorizationContent, signer: NodeId,
            registry_version: RegistryVersion,
        ) -> CryptoResult<()>;

        pub fn combine_basic_sig_upgrade_permit_auth(
            &self,
            signatures: BTreeMap<NodeId, BasicSigOf<UpgradePermitAuthorizationContent>>,
            registry_version: RegistryVersion,
        ) -> CryptoResult<BasicSignatureBatch<UpgradePermitAuthorizationContent>>;

        pub fn verify_basic_sig_batch_upgrade_permit_auth(
            &self,
            signature_batch: &BasicSignatureBatch<UpgradePermitAuthorizationContent>,
            message: &UpgradePermitAuthorizationContent,
            registry_version: RegistryVersion,
        ) -> CryptoResult<()>;
        ...
        pub fn verify_basic_sig_batch_multi_msg_upgrade_permit_auth(
            ...
            inputs: Vec<(
                NodeId,
                BasicSigOf<UpgradePermitAuthorizationContent>,
                UpgradePermitAuthorizationContent,
                RegistryVersion,
            )>,
        ) -> CryptoResult<()>;
