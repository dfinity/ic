...
fn bench_intmap(c: &mut Criterion<ProcessTime>) {
    ...
    for &n in BENCH_SIZES.iter() {
        let patricia_map: IntMap<u64, Value, _> = (0..n).map(|x| (x, value(x))).collect();
        let mpatricia_map: MutableIntMap<u64, Value, _> = (0..n).map(|x| (x, value(x))).collect();
        let patricia_128_map: MutableIntMap<Key128, Value, _> =
            (0..n).map(|x| (key128(x), value(x))).collect();
        let btree_map: Arc<BTreeMap<u64, Value>> =
            Arc::new((0..n).map(|x| (x, value(x))).collect());
        let btree_128_map: Arc<BTreeMap<Key128, Value>> =
            Arc::new((0..n).map(|x| (key128(x), value(x))).collect());
        let hash_map: Arc<HashMap<u64, Value>> = Arc::new((0..n).map(|x| (x, value(x))).collect());
        let hash_128_map: Arc<HashMap<Key128, Value>> =
            Arc::new((0..n).map(|x| (key128(x), value(x))).collect());
        group.bench_function(BenchmarkId::new("patricia", n), |b| {
            b.iter(|| {
                for i in 0..n {
        ...
        group.bench_function(BenchmarkId::new("mpatricia", n), |b| {
            b.iter(|| {
                for i in 0..n {
                    black_box(mpatricia_map.get(&i));
                    black_box(mpatricia_map.get(&(i + n)));
                }
            });
        });
        group.bench_function(BenchmarkId::new("patricia_128", n), |b| {
            b.iter(|| {
                for i in 0..n {
                    black_box(patricia_128_map.get(&key128(i)));
        ...
        group.bench_function(BenchmarkId::new("cow_btree_128", n), |b| {
            b.iter(|| {
                for i in 0..n {
                    black_box(btree_128_map.get(&key128(i)));
        ...
        group.bench_function(BenchmarkId::new("cow_hash_128", n), |b| {
            b.iter(|| {
                for i in 0..n {
                    black_box(hash_128_map.get(&key128(i)));
