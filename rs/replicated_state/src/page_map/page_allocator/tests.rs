...
fn test_page_allocation() {
    ...
    let page_0 = (PageIndex::new(0), &[0_u8; PAGE_SIZE]);
    let page_1 = (PageIndex::new(1), &[1_u8; PAGE_SIZE]);
    let page_2 = (PageIndex::new(2), &[2_u8; PAGE_SIZE]);
...
fn test_multiple_page_allocators() {
    ...
    let page = (PageIndex::new(1), &[1_u8; PAGE_SIZE]);
