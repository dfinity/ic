...
fn test_page_allocation() {
    ...
    let initialized = page_allocator.ensure_initialized();
...
fn test_multiple_page_allocators() {
    ...
    let initialized_1 = page_allocator_1.ensure_initialized();
    let pages_1 = page_allocator_1.allocate(initialized_1, &[page]);
    let initialized_2 = page_allocator_2.ensure_initialized();
