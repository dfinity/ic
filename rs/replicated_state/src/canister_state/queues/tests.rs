...
fn test_split_input_schedules() {
    ...
    let local_canisters = btreemap! {
        other_1 => Arc::new(CanisterState::new(system_state, None, SchedulerState::default(), UnflushedCheckpointOps::default()))
    };
...
fn time_out_messages_pushes_correct_reject_responses() {
    ...
    let local_canisters = maplit::btreemap! {
        local_canister_id => {
            ...
            Arc::new(CanisterState::new(system_state, None, scheduler_state, UnflushedCheckpointOps::default()))
        }
    };
