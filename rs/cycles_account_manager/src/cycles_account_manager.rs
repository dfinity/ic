...
impl CyclesAccountManager {
    ...
    fn scale_cost<T: CyclesUseCaseKind + Copy + Clone>(
        ...
        CompoundCycles::new(real, use_case_kind, cost_schedule)
    }
    ...
    pub fn charge_ingress_induction_cost(
        ...
        if canister.has_paused_execution() || canister.has_paused_install_code() {
            ...
            self.consume_with_threshold(
                ...
                CompoundCycles::new(cycles, IngressInduction, cost_schedule),
                threshold,
                reveal_top_up,
                cost_schedule,
            )
    ...
    pub fn compute_allocation_cost(
        ...
        self.scale_cost(
            cycles,
            subnet_size,
            ic_types_cycles::ComputeAllocation,
            cost_schedule,
        )
    }
    ...
    pub fn vetkd_fee(
        ...
        self.scale_cost(self.config.vetkd_fee, subnet_size, VetKd, cost_schedule)
    }
    ...
    pub fn memory_cost(
        ...
        self.scale_cost(cycles, subnet_size, Memory, cost_schedule)
    }
    ...
    pub fn http_request_fee(
        ...
        CompoundCycles::new(amount, HTTPOutcalls, cost_schedule)
    }
    ...
    pub fn leftover_cycles_for_canister_to_deleted(
        ...
        CompoundCycles::new(leftover_amount, DeletedCanisters, cost_schedule)
    }
