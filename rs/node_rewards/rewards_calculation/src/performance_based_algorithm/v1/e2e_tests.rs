...
fn test_failure_rate_calculation_various_performance() {
    ...
    let mut result = futures::executor::block_on(RewardsCalculationV1::calculate_rewards(
        day,
        day,
        fake_input_provider,
    ))
...
fn test_type3_reduction_coefficient_logic() {
    ...
    let result = futures::executor::block_on(RewardsCalculationV1::calculate_rewards(
        day,
        day,
        fake_input_provider,
    ))
