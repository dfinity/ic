...
1. RPC-like library that abstracts away communication between nodes.
2. Supports multitenancy of application protocols.
3. Works in P2P network with Byzantine peers.
