...
pub mod overhead {
    ...
    pub const ENV_VAR_COUNT: NumInstructions = NumInstructions::new(20);
    pub const ENV_VAR_NAME_SIZE: NumInstructions = NumInstructions::new(20);
    pub const ENV_VAR_NAME_COPY: NumInstructions = NumInstructions::new(20);
    pub const ENV_VAR_VALUE_SIZE: NumInstructions = NumInstructions::new(20);
    pub const ENV_VAR_VALUE_COPY: NumInstructions = NumInstructions::new(20);
