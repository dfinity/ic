...
pub(crate) trait NotificationClient {
    ...
    fn push_metrics_restored_height(&self, height: u64);
    fn push_metrics_synced_height(&self, height: u64);
    fn push_metrics_replay_time(&self, minutes: u64);
    fn push_metrics_sync_time(&self, minutes: u64);
...
impl NotificationClientImpl {
    ...
    fn message_slack(&self, message: impl Display) {
