...
mod tests {
    ...
    fn test_add_config_success() {
        ...
        // Config with identical rules. However, schema_version is now 2, hence all rules should be marked as "removed" and new ruled_ids must be regenerated by the canister
        ...
        // This config is identical to the previous one
        // NOTE: rule binary representations have changed, but not the inner JSON, so rules are in fact unchanged
        ...
        // This config adds two new rules and removes the first.
