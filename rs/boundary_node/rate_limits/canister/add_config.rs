...
// - Each rule must be linked to some incident_id, this ID must be provided for each input rule by the caller; multiple rules can be linked to one incident_id.
