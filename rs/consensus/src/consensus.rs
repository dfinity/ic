...
/// We will not notarize or validate with a height greater than the given value
/// above the latest certification . During validation, the only exception to this
/// are CUPs, which  have no upper bound on the height to be validated.
...
/// We will not notarize or validate with a height greater than the given value
/// above the latest CUP. During validation, the only exception to this are CUPs,
/// which have no upper bound on the height to be validated.
