...
impl ConsensusMessageHashable for Finalization {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::Finalization(ic_types::crypto::crypto_hash(self))
    }
...
impl ConsensusMessageHashable for FinalizationShare {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::FinalizationShare(ic_types::crypto::crypto_hash(self))
    }
...
impl ConsensusMessageHashable for Notarization {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::Notarization(ic_types::crypto::crypto_hash(self))
    }
...
impl ConsensusMessageHashable for NotarizationShare {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::NotarizationShare(ic_types::crypto::crypto_hash(self))
    }
...
impl ConsensusMessageHashable for RandomBeacon {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::RandomBeacon(ic_types::crypto::crypto_hash(self))
    }
...
impl ConsensusMessageHashable for RandomBeaconShare {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::RandomBeaconShare(ic_types::crypto::crypto_hash(self))
    }
...
impl ConsensusMessageHashable for BlockProposal {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::BlockProposal(ic_types::crypto::crypto_hash(self))
    }
    ...
    fn check_integrity(&self) -> bool {
        ...
        block.payload.is_summary() == block_payload.is_summary()
            && &ic_types::crypto::crypto_hash(block_payload) == payload_hash
            && &ic_types::crypto::crypto_hash(block) == block_hash
    }
}
...
impl ConsensusMessageHashable for RandomTape {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::RandomTape(ic_types::crypto::crypto_hash(self))
    }
...
impl ConsensusMessageHashable for RandomTapeShare {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::RandomTapeShare(ic_types::crypto::crypto_hash(self))
    }
...
impl ConsensusMessageHashable for CatchUpPackage {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::CatchUpPackage(ic_types::crypto::crypto_hash(self))
    }
    ...
    fn check_integrity(&self) -> bool {
        ...
        let block_payload = block.payload.as_ref();
        block.payload.is_summary() == block_payload.is_summary()
            && &ic_types::crypto::crypto_hash(random_beacon) == random_beacon_hash
            && &ic_types::crypto::crypto_hash(block) == block_hash
            && &ic_types::crypto::crypto_hash(block_payload) == payload_hash
    }
}
...
impl ConsensusMessageHashable for CatchUpPackageShare {
    ...
    fn get_cm_hash(&self) -> ConsensusMessageHash {
        ConsensusMessageHash::CatchUpPackageShare(ic_types::crypto::crypto_hash(self))
    }
    ...
    fn check_integrity(&self) -> bool {
        let content = &self.content;
        let random_beacon_hash = content.random_beacon.get_hash();
        &ic_types::crypto::crypto_hash(content.random_beacon.as_ref()) == random_beacon_hash
    }
}
