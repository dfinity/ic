#!/usr/bin/env python3
"""
Get Network Information Example

This script demonstrates how to fetch network information from the Internet Computer
...
and current state of the Internet Computer network.
...
Examples:
    ...
    python3 get_network_info.py --node-address http://localhost:8081 --raw
