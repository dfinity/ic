...
Examples:
    # Basic usage
    python3 get_network_info.py --node-address http://localhost:8082 --canister-id mxzaz-hqaaa-aaaar-qaada-cai

    # With raw JSON output
    python3 get_network_info.py --node-address http://localhost:8082 --canister-id mxzaz-hqaaa-aaaar-qaada-cai --raw

    # With verbose output
    python3 get_network_info.py --node-address http://localhost:8082 --canister-id mxzaz-hqaaa-aaaar-qaada-cai --verbose
"""
...
def main():
    ...
    networks = client.get_network_list(verbose=args.verbose)
    ...
    status = client.get_network_status(verbose=args.verbose)
    ...
    options = client.get_network_options(verbose=args.verbose)
