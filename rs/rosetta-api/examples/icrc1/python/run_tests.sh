...
print_usage() {
    ...
    echo "              --canister-id ryjl3-tyaaa-aaaaa-aaaba-cai \\"
    echo "              --principal-id 2ot7t-idkzt-murdg-in2md-bmcwr-3kkor-rs5wv-mnc7t-ataqc-fdlrt-pae"
    echo ""
    ...
    echo "              --to-principal 2g26g-pbzmq-azlqj-wajra-5jhhc-luhsb-6nzy5-ufgfe-oewhj-4bz36-vae \\"
    echo "              --amount 100 \\"
    echo "              --fee 10"
    echo -e "${BLUE}======================================================${NC}"
}
