...
test_bytes";
    ...
    "\n\n**Current withdrawal allowance:**\n1'000'000 e8s XTST",
    "\u{26A0} The allowance will be set to 1'000'000 e8s XTST independently of any previous allowance. Until this transaction has been executed the spender can still exercise the previous allowance (if any) to it's full amount.",
);
    assert_eq!(
        message, expected_message,
        "Expected: {}, got: {}",
