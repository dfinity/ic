...
impl LedgerState {
    ...
    fn verify_state_and_generate_transactions(
        ...
        ledger_state.fetch_next_blocks(state_machine, ledger_id, index_id, num_blocks_to_fetch);
        ...
        ledger_state.fetch_next_blocks(state_machine, ledger_id, index_id, None);
        ledger_state
    }
}
