...
#[test]
fn icrc1_test_upgrade_from_v3_not_possible() {
    ic_ledger_suite_state_machine_tests::test_upgrade_not_possible(
        ledger_mainnet_v3_wasm(),
        ledger_wasm(),
        "Migration to stable structures not supported",
        encode_init_args,
    );
}
...
fn test_icrc2_feature_flag_doesnt_disable_icrc2_endpoints() {
    ...
    let init_args = Encode!(&LedgerArgument::Init(InitArgs {
        ...
        max_memo_length: None,
        feature_flags: Some(FeatureFlags { icrc2: false, icrc152: false }),
    ...
    impl Setup {
        fn new() -> Self {
            ...
            let ledger_arg_init = LedgerArgument::Init(InitArgs {
                ...
                max_memo_length: None,
                feature_flags: Some(FeatureFlags { icrc2: true, icrc152: false }),
                index_principal: None,
            });
