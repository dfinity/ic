...
dfx ledger fabricate-cycles --t 500000 --canister icrc1-index
...
echo "dfx canister call icrc1-benchmark-generator run_scenario '(variant {IndexPerf})'"
