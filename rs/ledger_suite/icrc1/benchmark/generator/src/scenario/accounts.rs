...
const WORKER_BATCH_TRANSACTIONS: u64 = 5000;
    ...
    loop {
        ...
        for canister_id in &workers {
            let args = BatchArgs {
                ...
                scenario: ic_icrc1_benchmark_worker::Scenario::Accounts,
                users: None,
            };
        ...
        ic_cdk::println!(
            "[time {}] All {} workers completed their batches (size {}).",
            (ic_cdk::api::time() - start) / NANO,
            NB_WORKERS,
