...
mod tests {
    ...
    fn test_get_disk_encryption_key_token_custom_data_is_stable() {
        ...
        assert_eq!(
            ...
            // encoding, so take extra care!
            &[
                1, 0, 0, 0, 44, 96, 47, 104, 171, 127, 68, 166, 43, 242, 61, 116, 55, 229, 214,
                227, 107, 88, 24, 26, 223, 134, 119, 215, 136, 162, 198, 128, 60, 107, 133, 229,
                145, 220, 92, 231, 186, 211, 34, 11, 30, 155, 53, 20, 23, 114, 250, 74, 83, 143,
                28, 23, 30, 166, 65, 176, 215, 27, 136, 191
            ]
        );
    }
}
