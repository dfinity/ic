...
// As a routing sanity check, require the sender to echo its own guest CID in
// the request and ensure it matches the stream peer address. This helps catch
// malformed or confused requests, but it is not a cryptographic identity check.
