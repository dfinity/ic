...
use crate::protocol::HostOSVsockVersion;
...
#[automock]
#[async_trait]
pub trait VsockServer {
    async fn listen(self, cancellation_token: CancellationToken);
}
...
mod linux {
    ...
    pub struct LinuxVsockServer {
        listener: VsockListener,
    }

    impl LinuxVsockServer {
    ...
    #[async_trait]
    impl VsockServer for LinuxVsockServer {
        async fn listen(self, cancellation_token: CancellationToken) {
