...
pub struct BootstrapOptions {
    ...
    /// Externally generated cryptographic keys. Must be a directory with contents
    /// matching the internal representation of the ic_crypto directory, typically
    /// generated by ic-prep (IC_PREP_OUT_PATH/node-X/crypto).
    /// When provided, this supplies the private keys of the node.
    ...
    /// Initial registry state. Must be a directory with contents matching the
    /// internal representation of the ic_registry_local_store, typically generated
    /// by ic-prep (IC_PREP_OUT_PATH/ic_registry_local_store).
    /// When provided, this supplies the initial state of the registry.
