...
use ic_interfaces::{
    ...
    p2p::consensus::{FilterFn, FilterFnFactory, FilterValue},
};
...
/// The canonical implementation of [`FilterFnFactory`]
...
impl<Pool: CanisterHttpPool> FilterFnFactory<CanisterHttpResponseShare, Pool>
    for CanisterHttpGossipImpl
{
    fn get_filter_function(&self, _canister_http_pool: &Pool) -> FilterFn<CanisterHttpResponseId> {
