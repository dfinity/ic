...
impl ExecutionTest {
    ...
    pub fn canister_snapshot_cost(&self, canister_id: CanisterId) -> Cycles {
        ...
        self.cycles_account_manager
            .management_canister_cost(instructions, self.subnet_size())
    }
    ...
    fn expected_cycles_balance_change(
        ...
        match method {
            ...
            | Ok(Method::UploadCanisterSnapshotData) => self
                ...
                .management_canister_cost(instructions_used, subnet_size),
            _ => {
        ...
        if let Some(canister_id) = maybe_canister_id {
            match execute_subnet_message_result_type {
                ExecuteSubnetMessageResultType::Finished => {
                    ...
                    if is_install_code {
                        self.update_execution_stats(canister_id, capped_slice_instructions_used);
                    }
                }
            ...
            NextExecution::ContinueInstallCode => {
                ...
                match execute_subnet_message_result_type {
                    ExecuteSubnetMessageResultType::Finished => {
                        ...
                        self.update_execution_stats(canister_id, capped_instructions_used);
                    }
                    ExecuteSubnetMessageResultType::Processing => {
                        unreachable!()
                    }
