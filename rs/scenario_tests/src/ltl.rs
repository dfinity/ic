...
mod tests {
    ...
    fn log_entries_from_from_str() {
        let log_entries = vec![
            r#"3dwph-vnvnt-nvv7a-jncv5-pw3qa-dylnr-mxi4r-2siya-w7y74-c7euw-hae: {"log_entry":{"level":"INFO","utc_time":"2020-12-04T09:08:39.364Z","message": "Downloading release package for replica version 0.1.0","crate_":"orchestrator","module":"release_package_provider","line": 77,"node_id":"","subnet_id":""}}"#,
            ...
            r#"iosfi-paqab-t2kqj-3ymjk-n7hgf-5reii-tkbjd-gtc3s-iqqys-xcxip-kqe: {"log_entry":{"level":"INFO","utc_time":"2020-12-07T09:40:07.538Z","message":"No local release package detected for version 0.1.0","crate_":"orchestrator","module":"orchestrator","line":236,"node_id":"","subnet_id":""}}"#,
        ];
