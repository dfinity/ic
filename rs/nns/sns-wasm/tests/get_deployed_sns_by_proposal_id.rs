...
fn test_get_deployed_sns_by_proposal_id() {
    ...
    // NODE_REWARDS_CANISTER_INDEX_IN_NNS_SUBNET + 1 is the ID of the wallet canister
    let root_canister_id = canister_test_id(NODE_REWARDS_CANISTER_INDEX_IN_NNS_SUBNET + 1);
    let governance_canister_id = canister_test_id(NODE_REWARDS_CANISTER_INDEX_IN_NNS_SUBNET + 2);
    let ledger_canister_id = canister_test_id(NODE_REWARDS_CANISTER_INDEX_IN_NNS_SUBNET + 3);
    let swap_canister_id = canister_test_id(NODE_REWARDS_CANISTER_INDEX_IN_NNS_SUBNET + 4);
    let index_canister_id = canister_test_id(NODE_REWARDS_CANISTER_INDEX_IN_NNS_SUBNET + 5);
