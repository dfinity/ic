...
backend canisters (solid edges are real Candid calls; the dotted orange edge
is a proposal-specified arbitrary-target relay). Source: `docs/canister_call_graph.dot`.
