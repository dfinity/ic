...
The diagram below shows the inter-canister call relationships between the NNS
backend canisters.

image::docs/canister_call_graph.svg[NNS backend canisters: inter-canister call graph,width=900]

To regenerate `docs/canister_call_graph.svg` after editing `docs/canister_call_graph.dot`, run:
[code,shell]
----
dot -Tsvg docs/canister_call_graph.dot -o docs/canister_call_graph.svg
----
