...
impl ValidNnsFunction {
    ...
    pub(crate) fn canister_and_function(&self) -> (CanisterId, &'static str) {
        match self {
            ...
            ValidNnsFunction::DeploySlowToSomeNodes => {
                (REGISTRY_CANISTER_ID, "deploy_slow_to_some_nodes")
            }
        }
    }
    ...
    pub(crate) fn type_name(&self) -> &'static str {
        match self {
            ...
            ValidNnsFunction::DeploySlowToSomeNodes => "Deploy slow To Some Nodes",
    ...
    pub(crate) fn type_description(&self) -> &'static str {
        match self {
            ...
            ValidNnsFunction::DeploySlowToSomeNodes => {
                "Deploy a slow version to a given set of nodes. The proposal \
...
impl TryFrom<NnsFunction> for ValidNnsFunction {
    ...
    fn try_from(value: NnsFunction) -> Result<Self, Self::Error> {
        ...
        match value {
            ...
            NnsFunction::DeploySlowToSomeNodes => Ok(ValidNnsFunction::DeploySlowToSomeNodes),
        }
    }
}
