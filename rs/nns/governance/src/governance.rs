use crate::{
    ...
    pb::{
        ...
        v1::{
            ...
            ListProposalInfo, ManageNeuron, ManageNeuronResponse, MonthlyNodeProviderRewards,
...
impl Governance {
    ...
    pub fn get_neuron_ids_by_principal(&self, principal_id: &PrincipalId) -> HashSet<NeuronId> {
        self.neuron_store
