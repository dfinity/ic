...
impl From<pb::NnsFunction> for api::NnsFunction {
    fn from(item: pb::NnsFunction) -> Self {
        match item {
            ...
            pb::NnsFunction::DeployGuestosToSomeNodes => api::NnsFunction::DeployGuestosToSomeNodes,
        }
    }
}
impl From<api::NnsFunction> for pb::NnsFunction {
    fn from(item: api::NnsFunction) -> Self {
        match item {
            ...
            api::NnsFunction::DeployGuestosToSomeNodes => pb::NnsFunction::DeployGuestosToSomeNodes,
        }
    }
}
