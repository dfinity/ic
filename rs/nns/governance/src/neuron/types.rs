        ...
        impl<'a> Normalized<'a> {
            fn new(src: &'a Neuron) -> Self {
                ...
                Self {
                    ...
                    visibility,
                    recent_ballots_next_entry_index: recent_ballots_next_entry_index.clone(),
                }
            }
        }
...
impl Neuron {
    ...
    pub(crate) fn register_recent_ballot(
        ...
        self.register_recent_ballot_b(topic, proposal_id, vote);
    }
    ...
    pub(crate) fn register_recent_ballot_a(
        &mut self,
        topic: Topic,
        proposal_id: &ProposalId,
        vote: Vote,
    ...
    /// proposal. Don't include votes on "real time" topics (such as
    /// setting the ICP/SDR exchange rate).
    pub(crate) fn register_recent_ballot_b(
        &mut self,
        topic: Topic,
        proposal_id: &ProposalId,
        vote: Vote,
        ...
        if None == self.recent_ballots_next_entry_index {
