...
/// The minimum amount of ICP that need to be minted when disbursing maturity. A neuron can only disburse an amount of maturity that results in minting at least this many ICP (in e8) assuming the worst case maturity modulation.
