...
#[test]
fn test_record_known_neuron_votes() {
    ...
    record_known_neuron_votes(
        ...
        hashmap! {
            ...
            2 => Ballot { voting_power: 1, vote: Vote::No as i32 },
            3 => Ballot { voting_power: 1, vote: Vote::Unspecified as i32 },
            4 => Ballot { voting_power: 1, vote: Vote::Yes as i32 },
        },
    );
    ...
    record_known_neuron_votes(
        ...
        ProposalId { id: 2 },
        hashmap! {
            1 => Ballot { voting_power: 1, vote: Vote::No as i32 },
            3 => Ballot { voting_power: 1, vote: Vote::Yes as i32 },
