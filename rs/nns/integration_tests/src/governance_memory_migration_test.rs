...
// TODO NNS1-2357: Remove this after deployment

#[test]
fn governance_memory_migration_test() {
    let state_machine = StateMachine::new();

    let state_setup_wasm =
        Project::cargo_bin_maybe_from_env("governance-memory-migration-test-canister", &[]);
    ...
    assert_eq!(decoded.proposal_info.len(), 10);
