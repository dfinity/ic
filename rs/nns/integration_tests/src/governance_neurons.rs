...
use ic_nns_test_utils::{
    ...
    state_test_helpers::{
        ...
        nns_join_community_fund, nns_leave_community_fund, nns_make_neuron_public,
        nns_remove_hot_key, nns_send_icp_to_claim_or_refresh_neuron, nns_set_auto_stake_maturity,
