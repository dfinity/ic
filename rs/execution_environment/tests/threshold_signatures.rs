...
use ic_management_canister_types::{
    self as ic00, CanisterInstallMode, DerivationPath, EcdsaCurve, EcdsaKeyId, MasterPublicKeyId,
    Method, Payload as Ic00Payload, SchnorrAlgorithm, SchnorrKeyId, SignWithECDSAReply,
...
// TODO(EXC-1658): implement testing disabled keys.
// #[test]
...
//                     public_key_method,
//                     call_args()
//                         .other_side(threshold_public_key_payload(
//                             public_key_method,
//                             disabled_key.clone(),
//                         ))
//                         .on_reject(wasm().reject_message().reject()),
...
//                 assert!(!response.chain_code.is_empty());
//             }
//             Method::SchnorrPublicKey => {
...
//                     sign_with_method,
//                     call_args()
//                         .other_side(sign_with_threshold_key_payload(
//                             sign_with_method,
//                             disabled_key.clone(),
//                         ))
//                         .on_reject(wasm().reject_message().reject()),
...
//         assert_eq!(message, "TODO: provide a proper reject message");
