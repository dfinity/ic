...
pub fn benchmark(c: &mut Criterion) {
    ...
    baseline_bench(&mut group, "10MiB", 10 * MIB);
    baseline_bench(&mut group, "100MiB", 100 * MIB);
    baseline_bench(&mut group, "1GiB", GIB);
    baseline_bench(&mut group, "2GiB", 2 * GIB);
    group.finish();

    let mut group = c.benchmark_group("take_canister_snapshot");
    take_canister_snapshot_bench(&mut group, "10MiB", 10 * MIB);
    take_canister_snapshot_bench(&mut group, "100MiB", 100 * MIB);
    take_canister_snapshot_bench(&mut group, "1GiB", GIB);
    take_canister_snapshot_bench(&mut group, "2GiB", 2 * GIB);
    group.finish();

    let mut group = c.benchmark_group("replace_canister_snapshot");
    replace_canister_snapshot_bench(&mut group, "10MiB", 10 * MIB);
    replace_canister_snapshot_bench(&mut group, "100MiB", 100 * MIB);
    replace_canister_snapshot_bench(&mut group, "1GiB", GIB);
    replace_canister_snapshot_bench(&mut group, "2GiB", 2 * GIB);
    group.finish();

    let mut group = c.benchmark_group("load_canister_snapshot");
    load_canister_snapshot_bench(&mut group, "10MiB", 10 * MIB);
    load_canister_snapshot_bench(&mut group, "100MiB", 100 * MIB);
    load_canister_snapshot_bench(&mut group, "1GiB", GIB);
    load_canister_snapshot_bench(&mut group, "2GiB", 2 * GIB);
    group.finish();
}
