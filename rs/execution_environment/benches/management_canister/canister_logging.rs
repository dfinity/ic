...
use ic_management_canister_types_private::{
    CanisterInstallMode, CanisterSettingsArgsBuilder, FetchCanisterLogsRequest, LogVisibilityV2,
    Payload,
};
...
) -> (ic_state_machine_tests::StateMachine, CanisterId) {
...
fn run_bench_fetch_canister_log<M: criterion::measurement::Measurement>(
    ...
    group.bench_function(bench_name, |b| {
        b.iter_batched(
            || setup_canister_with_full_log(log_memory_limit, log_message_size),
            |(env, canister_id)| {
