...
impl CanisterManager {
    ...
    pub(crate) fn install_code_dts(
        ...
        let original: OriginalContext = OriginalContext {
            ...
            subnet_size: subnet_config.subnet_size,
        ...
        let round = RoundContext {
            ...
            log: &self.log,
            time,
            cost_schedule: subnet_config.cost_schedule,
        };
    ...
    pub(crate) fn upload_chunk(
        ...
        let cost = self
            .cycles_account_manager
            .management_canister_cost(instructions, subnet_config);
        self.cycles_account_manager
    ...
    fn cycles_and_memory_usage_checks_and_updates(
        ...
        let new_storage_reservation_cycles = self
            .cycles_account_manager
            .storage_reservation_cycles(allocated_bytes, resource_saturation, subnet_config);
        canister
            .system_state
    ...
    pub(crate) fn take_canister_snapshot(
        ...
        let deleted_call_context_responses = if uninstall_code {
            let rejects = uninstall_canister(
                &self.log,
                canister,
                None, /* we don't pass RoundLimits since we update them separately */
                time,
                Arc::clone(&self.fd_factory),
            );
            let available_execution_memory_change = canister.add_canister_change(
    ...
    pub(crate) fn load_canister_snapshot(
        ...
        let new_execution_state = {
            ...
            let cycles_to_refund = self
                .cycles_account_manager
                .variable_execution_cost(instructions_to_refund, subnet_config, wasm_execution_mode)
    ...
    pub(crate) fn read_snapshot_data(
        ...
        let cost = self
            .cycles_account_manager
            .management_canister_cost(num_instructions, subnet_config);
