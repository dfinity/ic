...
impl InstallCodeHelper {
    ...
    pub fn resume(
        ...
        (
            ...
            NumInstructions,
            (CanisterLog, Option<LogMemoryStore>),
        ),
    > {
    ...
    pub(crate) fn take_canister_log(&mut self) -> (CanisterLog, Option<LogMemoryStore>) {
        ...
        (
            ...
            self.canister
                .execution_state
                .as_ref()
                .map(|exec_state| exec_state.log_memory_store.clone()),
        )
    }
...
pub(crate) fn finish_err(
    ...
    new_canister_log: (CanisterLog, Option<LogMemoryStore>),
) -> DtsInstallCodeResult {
