...
impl SigsegvMemoryTracker {
    ...
    pub fn handle_sigsegv(
        ...
        match self.missing_page_handler_kind {
            ...
            MissingPageHandlerKind::Deterministic => {
                deterministic::handle_missing_os_page(self, access_kind, fault_address)
            }
        }
    }
    ...
    pub fn take_dirty_pages(&self) -> Vec<PageIndex> {
        match self.missing_page_handler_kind {
            ...
            MissingPageHandlerKind::Deterministic => deterministic::take_dirty_os_pages(self),
        }
    }
    ...
    pub fn num_accessed_pages(&self) -> usize {
        match self.missing_page_handler_kind {
            ...
            MissingPageHandlerKind::Deterministic => {
                deterministic::num_accessed_os_pages(self).get() as usize
            }
        }
    }
