...
impl PageBitmap {
    ...
    fn restrict_range_to_predicted(
        ...
        while bwd_predicted_count <= page && start <= page - bwd_predicted_count {
            if !self
                .pages
                .get((page + bwd_predicted_count) as usize)
                .unwrap_or(false)
            {
                break;
            }
        ...
        Range {
            start: PageIndex::new(page.saturating_sub(bwd_predicted_count)),
