# Proposal to change the reserved cycles limit of the ckBTC ledger canister
...
## Motivation
Raise the `reserved_cycles_limit` of the ckBTC ledger canister from its current value of `5_000_000_000_000` (5T cycles, the default) to `1_000_000_000_000_000_000`.
