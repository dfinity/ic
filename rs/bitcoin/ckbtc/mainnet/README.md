...
```shell
didc encode -d ../../../rosetta-api/icrc1/ledger/icrc1.did -t '(LedgerArg)' '(variant { Upgrade = null })' | xxd -r -p > ledger_upgrade_arg.bin
```
