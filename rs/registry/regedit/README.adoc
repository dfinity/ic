...
we updated a node's reward type. The output should look like this:

----
$ ic-regedit show-diff /path/to/ic_registry_local_store snapshot.json
{
  "__version": 3,
  "node_record_635b7-ykceq-3uanz-33q36-5yf2v-l2yod-czr5t-pqyu7-vivl4-scd2f-zae": {
    "chip_id": null,
    "domain": null,
    "hostos_version_id": null,
    "http": {
      "ip_addr": "2602:fb2b:100:10:5000:25ff:fe89:bd2b",
      "port": 8080
    },
    "node_operator_id": "(binary-data)",
    "node_reward_type": 5,
    "public_ipv4_config": null,
    "ssh_node_state_write_access": "(binary-data)",
    "xnet": {
      "ip_addr": "2602:fb2b:100:10:5000:25ff:fe89:bd2b",
      "port": 2497
    }
