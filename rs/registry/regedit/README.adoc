...
we updated the subnet list. The output should look like this:
...
$ ic-regedit show-diff /path/to/ic_registry_local_store snapshot.json
{
  ...
  "subnet_list": {
    "subnets": [
      "(principal-id)ctkw5-pjdpp-oliv3-h7q4x-vd542-t6ezo-kbolh-yynez-7yewq-gq4bj-nqe",
      "(principal-id)i5ubr-s2mcz-ghnc4-jxodo-uvrtp-rrx6m-pcv3n-xf7fe-oqxbp-efsg5-2qe",
      "(principal-id)th2o5-oflhf-ixact-nhmok-hupll-gf67c-5hn6k-7hh5a-hcwhs-rvcdb-5ae"
    ]
  }
}
----
