...
mod tests {
    ...
    fn init_ipv4_config() -> IPv4Config {
        IPv4Config::new("193.118.59.140".into(), "193.118.59.137".into(), 29).unwrap()
    }
    ...
    fn should_panic_if_gateway_is_invalid() {
        ...
        let ipv4_config =
            IPv4Config::new("193.118.59.140".into(), "193.118.999.137".into(), 29).unwrap();
    ...
    fn should_panic_if_address_and_gateway_not_in_same_subnet() {
        ...
        // create IPv4 config with invalid gateway IP
        let ipv4_config =
            IPv4Config::new("193.118.59.140".into(), "193.105.231.137".into(), 29).unwrap();
    ...
    fn should_panic_if_address_is_private() {
        ...
        let ipv4_config =
            IPv4Config::new("192.168.178.6".into(), "192.168.178.1".into(), 29).unwrap();
    ...
    fn should_panic_if_prefix_length_is_invalid() {
        ...
        let ipv4_config =
            IPv4Config::new("193.118.59.140".into(), "193.118.59.137".into(), 34).unwrap();
