...
async fn caller_not_whitelisted() {
    ...
    let builder = RegistryCanisterInitPayloadBuilder::new().enable_swapping_feature_globally();

    install_registry_canister_with_payload_builder(&pocket_ic, builder, true).await;
