...
use ic_nns_test_utils::registry::{
    generate_nidkg_initial_transcript, get_committee_signing_key, get_dkg_dealing_key,
    get_idkg_dealing_encryption_key, get_node_record, get_node_signing_key,
...
fn add_threshold_signing_pubkey_and_cup_to_mutations(
    subnet_id: SubnetId,
