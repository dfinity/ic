...
use general_execution_tests::api_tests::subnet_metrics_composite_query_fails;
use general_execution_tests::api_tests::subnet_metrics_non_existing_subnet_fails;
use general_execution_tests::api_tests::subnet_metrics_own_subnet_succeeds;
    ...
    SystemTestGroup::new()
        ...
        .add_parallel(
            SystemTestSubGroup::new()
                ...
                .add_test(systest!(subnet_metrics_own_subnet_succeeds))
                ...
                .add_test(systest!(subnet_metrics_composite_query_fails))
