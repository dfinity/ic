    ...
    match topology {
        NetworkSimulation::Subnet(subnet) => {
            ...
            for source_node in 0..13 {
                ...
                tc_command.push_str(format!("sudo tc class add dev enp1s0 parent 1: classid 1:10 htb rate {bandwidth_mbit}mbit ceil {bandwidth_mbit}mbit \n",  bandwidth_mbit=BANDWIDTH_MBITS).as_str());
