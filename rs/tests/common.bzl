...
NNS_CANISTER_WASM_PROVIDERS = {
    "registry-canister": {
        ...
        "mainnet": "@mainnet_canisters//:registry-canister.wasm.gz",
    },
    "governance-canister_test": {
        "tip-of-branch": "//rs/nns/governance:governance-canister-test",
        "mainnet": "@mainnet_canisters//:governance-canister.wasm.gz",
    },
    "ledger-canister": {
        "tip-of-branch": "//rs/ledger_suite/icp/ledger:ledger-canister-wasm",
        "mainnet": "@mainnet_canisters//:ledger-canister_notify-method.wasm.gz",
    },
    "root-canister": {
        "tip-of-branch": "//rs/nns/handlers/root/impl:root-canister",
        "mainnet": "@mainnet_canisters//:root-canister.wasm.gz",
    },
    "cycles-minting-canister": {
        "tip-of-branch": "//rs/nns/cmc:cycles-minting-canister",
        "mainnet": "@mainnet_canisters//:cycles-minting-canister.wasm.gz",
    },
    "lifeline_canister": {
        "tip-of-branch": "//rs/nns/handlers/lifeline/impl:lifeline_canister",
        "mainnet": "@mainnet_canisters//:lifeline_canister.wasm.gz",
    },
    "genesis-token-canister": {
        "tip-of-branch": "//rs/nns/gtc:genesis-token-canister",
        "mainnet": "@mainnet_canisters//:genesis-token-canister.wasm.gz",
    },
    "sns-wasm-canister": {
        "tip-of-branch": "//rs/nns/sns-wasm:sns-wasm-canister",
        "mainnet": "@mainnet_canisters//:sns-wasm-canister.wasm.gz",
    },
    "node-rewards": {
        "tip-of-branch": "//rs/node_rewards/canister:node-rewards-canister",
        "mainnet": "@mainnet_canisters//:node-rewards-canister.wasm.gz",
    },
    "migration-canister": {
...
SNS_CANISTER_WASM_PROVIDERS = {
    "sns-root-canister": {
        ...
        "mainnet": "@mainnet_canisters//:sns-root-canister.wasm.gz",
    },
    "sns-governance-canister": {
        "tip-of-branch": "//rs/sns/governance:sns-governance-canister",
        "mainnet": "@mainnet_canisters//:sns-governance-canister.wasm.gz",
    },
    "sns-swap-canister": {
        "tip-of-branch": "//rs/sns/swap:sns-swap-canister",
        "mainnet": "@mainnet_canisters//:sns-swap-canister.wasm.gz",
    },
    "ic-icrc1-ledger": {
        "tip-of-branch": "//rs/ledger_suite/icrc1/ledger:ledger_canister",
        "mainnet": "@mainnet_canisters//:ic-icrc1-ledger.wasm.gz",
    },
    "ic-icrc1-archive": {
        "tip-of-branch": "//rs/ledger_suite/icrc1/archive:archive_canister",
        "mainnet": "@mainnet_canisters//:ic-icrc1-archive.wasm.gz",
    },
    "ic-icrc1-index-ng": {
        "tip-of-branch": "//rs/ledger_suite/icrc1/index-ng:index_ng_canister",
        "mainnet": "@mainnet_canisters//:ic-icrc1-index-ng.wasm.gz",
    },
}
