...
use ic_tests::boundary_nodes::boundary_nodes_integration::{
    ...
    direct_to_replica_rosetta_test, direct_to_replica_test, headers_test, http_canister_test,
    http_endpoint_test, icx_proxy_test, nginx_valid_config_test, prefix_canister_id_test,
    proxy_http_canister_test, reboot_test, redirect_http_to_https_test, redirect_to_dashboard_test,
