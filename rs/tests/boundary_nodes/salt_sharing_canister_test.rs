...
3. Retrieve the `last_salt_id` metric from the ic-boundary and assert is greater than zero
...
const IC_BOUNDARY_SALT_METRIC: &str = "ic_boundary_salt_sharing_last_salt_id";
...
async fn test_async(env: TestEnv) {
    ...
    retry_with_msg_async!(
        "check_last_salt_id_metrics_is_set".to_string(),
        &logger,
