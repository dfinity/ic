// This test displays in Grafana the byte throughput of the consensus subsystem.
// In order to run it use following commands:
//   gitlab-ci/container/container-run.sh
// then in the container run:
//   ict testnet //rs/tests/consensus:throughput_with_large_messages_colocate --keepalive
