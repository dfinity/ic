...
use ic_consensus_system_test_utils::{
    ...
    ssh_access::{
        AuthMean, generate_key_strings, get_update_ssh_readonly_access_keys_payload,
...
fn test(env: TestEnv) {
    ...
    let payload = get_update_ssh_readonly_access_keys_payload(vec![readonly_public_key.clone()]);
