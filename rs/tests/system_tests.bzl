...
def system_test(
    ...
    _local_only_deps["ENV_DEPS__QEMU_IMG_PATH"] = "@rules_qemu//qemu:qemu-img"
    _local_only_deps["ENV_DEPS__QEMU_SYSTEM_X86_64_PATH"] = "@rules_qemu//qemu:qemu-system-x86_64"
    _local_only_deps["ENV_DEPS__QEMU_SYSTEM_DATA_PATH"] = "@rules_qemu//qemu:qemu-system-data"
