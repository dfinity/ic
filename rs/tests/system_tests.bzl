...
def system_test(
    ...
    if uses_setupos_dev:
        ...
        _env_deps["//rs/ic_os/dev_tools/setupos-disable-checks"] = "ENV_DEPS__SETUPOS_DISABLE_CHECKS"
        _env_deps["//rs/ic_os/dev_tools/setupos-inject-configuration"] = "ENV_DEPS__SETUPOS_INJECT_CONFIGS"
