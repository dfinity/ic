...
def system_test(
    ...
    Args:
      ...
      guestos: The guestos version. Values: True (HEAD) | False | "malicious" | "mainnet_latest" | "mainnet_latest_dev" | "mainnet_nns" | "mainnet_nns_dev" | "mainnet_app" | "recovery_dev". Default: True
...
def _configure_icos(env, env_var_files, icos_images, runtime_deps, guestos, guestos_update, setupos, hostos_update):
    ...
    if guestos == True:  # HEAD version
        ...
        guestos_mainnet(MAINNET_NNS, "@mainnet_nns_images_dev", dev = True)
