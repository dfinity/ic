...
def system_test(
    ...
    if uses_setupos_mainnet_latest_img:
        ...
        _runtime_deps["ENV_DEPS__GUESTOS_INITIAL_LAUNCH_MEASUREMENTS_FILE"] = "@mainnet_latest_hostos_images//:launch-measurements-guest.json" if "dev" not in guestos else "@mainnet_latest_hostos_images_dev//:launch-measurements-guest.json"
