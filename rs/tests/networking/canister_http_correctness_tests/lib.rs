...
use ic_system_test_driver::{
    ...
    driver::{test_env::TestEnv, test_env_api::HasTopologySnapshot},
...
pub fn enforce_https(env: &TestEnv) -> RemoteHttpRequest {
...
pub fn transform_function_is_executed(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn non_existent_transform_function(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    let transform_context = "transform_context".as_bytes().to_vec();
...
pub fn composite_transform_function_is_executed(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn no_cycles_attached(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
            url: format!("http://[{webserver_ipv6}]:20443"),
...
pub fn max_possible_request_size(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn max_possible_request_size_exceeded(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    let headers_list = vec![
        ("name1".to_string(), "value1".to_string()),
        ("name2".to_string(), "value2".to_string()),
...
pub fn size_2mb_response_insufficient_cycles_for_rejection_path(
    env: &TestEnv,
) -> RemoteHttpRequest {
    ...
    RemoteHttpRequest {
        ...
        cycles: expected_cycle_cost(
            ...
            request.clone(),
            handlers.get_subnet_size(),
        ) - 1,
    }
}

pub fn size_4096_max_response_cycle_case_1(env: &TestEnv) -> RemoteHttpRequest {
    let handlers = Handlers::new(&env);
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn size_4096_max_response_insufficient_cycles_case_2(env: &TestEnv) -> RemoteHttpRequest {
    let handlers = Handlers::new(&env);
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn max_response_bytes_2_mb_returns_ok(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
            url: format!("https://[{webserver_ipv6}]:20443"),
...
pub fn max_response_bytes_too_large(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
            url: format!("https://[{webserver_ipv6}]:20443"),
...
pub fn transform_that_bloats_on_the_2mb_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
            url: format!("https://[{webserver_ipv6}]:20443"),
...
pub fn transform_that_bloats_response_above_2mb_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn post_request(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
...
pub fn http_endpoint_response_is_within_limits_with_custom_max_response_bytes(
    env: &TestEnv,
) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn http_endpoint_response_is_too_large_with_custom_max_response_bytes(
    env: &TestEnv,
) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn http_endpoint_response_is_within_limits_with_default_max_response_bytes(
    env: &TestEnv,
) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
...
pub fn http_endpoint_response_is_too_large_with_default_max_response_bytes(
    env: &TestEnv,
) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn http_endpoint_with_delayed_response_is_rejected(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
...
pub fn that_redirects_are_not_followed(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
...
pub fn http_calls_to_ic_fails(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
...
pub fn invalid_domain_name(env: &TestEnv) -> RemoteHttpRequest {
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
...
pub fn invalid_ip(env: &TestEnv) -> RemoteHttpRequest {
    RemoteHttpRequest {
        request: UnvalidatedCanisterHttpRequestArgs {
...
pub fn get_hello_world_call(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    let body = "hello_world";

    let url = format!("https://[{}]:20443/{}/{}", webserver_ipv6, "ascii", body);
...
pub fn request_header_total_size_within_the_48_kib_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn request_header_total_size_over_the_48_kib_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn response_header_total_size_within_the_48_kib_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn response_header_total_size_over_the_48_kib_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn request_header_name_and_value_within_limits(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn request_header_name_too_long(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn request_header_value_too_long(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn response_header_name_within_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn response_header_name_over_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn response_header_value_within_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn response_header_value_over_limit(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn post_call(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn head_call(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn small_maximum_possible_response_size_only_headers(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn small_maximum_possible_response_size_exceeded_only_headers(
    env: &TestEnv,
) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn non_ascii_url_is_rejected(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    let body = "안녕하세요";
...
pub fn max_url_length(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn max_url_length_exceeded(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn reference_transform_function_exposed_by_different_canister(
    env: &TestEnv,
) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    let url = format!(
...
pub fn max_number_of_response_headers(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn max_number_of_response_headers_exceeded(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn max_number_of_request_headers(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
...
pub fn check_caller_id_on_transform_function(env: &TestEnv) -> RemoteHttpRequest {
    let webserver_ipv6 = get_universal_vm_address(&env);
    let url = format!(
        "https://[{}]:20443/{}/{}",
        webserver_ipv6, "ascii", "hello_world"
