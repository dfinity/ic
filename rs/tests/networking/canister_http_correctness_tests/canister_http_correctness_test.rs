    ...
    SystemTestGroup::new()
        ...
        .add_sequential(
            SystemTestSubGroup::new()
                ...
                .add_test(systest!(test_size_2mb_response_cycle_for_rejection_path))
                .add_test(systest!(test_size_4096_max_response_cycle_case_1))
                .add_test(systest!(test_size_4096_max_response_cycle_case_2))
...
fn test_size_2mb_response_cycle_for_rejection_path(env: TestEnv) {
    let request = size_2mb_response_cycle_for_rejection_path(&env);
...
fn test_size_4096_max_response_cycle_case_2(env: TestEnv) {
    let request = size_4096_max_response_cycle_case_2(&env);
