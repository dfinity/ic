...
- The argument of the endpoint `/instances/<instance_id>/auto_progress` takes an optional field `artificial_delay_ms` specifying a minimum delay between consecutive rounds in auto progress mode.
