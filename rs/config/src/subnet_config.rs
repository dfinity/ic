...
// Observations on pjljw from 02.02.2020 show that finalization took 13ms when
// there were 5000 canisters. This comes out to about 3us per canister which
// comes out to 6_000 instructions based on the 1 cycles unit ≅ 1 CPU cycle, 2
// GHz CPU calculations. Round this up to 15_000 to be on the safe side.
pub(crate) const INSTRUCTION_OVERHEAD_PER_CANISTER_FOR_FINALIZATION: NumInstructions =
    NumInstructions::new(15_000);
