use crate::{
    ...
    pb::{
        ...
        v1::{
            ...
            ClaimedSwapNeuronStatus, DeregisterDappCanisters, Empty,
...
use ic_nervous_system_common::{
    hash_to_hex_string, ledger_validation::MAX_LOGO_LENGTH, NervousSystemError, ONE_DAY_SECONDS,
};
...
use ic_sns_governance_api::pb::v1::NervousSystemParameters as NervousSystemParametersApi;
...
impl NervousSystemParameters {
    ...
    pub fn with_default_values() -> Self {
        let api = NervousSystemParametersApi::default();
        NervousSystemParameters::from(api)
    }
    ...
    fn validate_neuron_claimer_permissions(&self) -> Result<(), String> {
        ...
        let required_claimer_permissions =
