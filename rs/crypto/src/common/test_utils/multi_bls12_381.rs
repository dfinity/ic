...
pub fn testvec(
    ...
    match test_vec {
        MultiBls12381TestVector::STABILITY_1 => {
            let sk = csp_sk_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_1_SK);
            let pk = csp_pk_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_1_PK);
            let pop = csp_pop_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_1_POP);
        ...
        MultiBls12381TestVector::STABILITY_2 => {
            let sk = csp_sk_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_2_SK);
            let pk = csp_pk_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_2_PK);
            let pop = csp_pop_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_2_POP);
        ...
        MultiBls12381TestVector::STABILITY_3 => {
            let sk = csp_sk_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_3_SK);
            let pk = csp_pk_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_3_PK);
            let pop = csp_pop_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_3_POP);
        ...
        MultiBls12381TestVector::STABILITY_4 => {
            let sk = csp_sk_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_4_SK);
            let pk = csp_pk_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_4_PK);
            let pop = csp_pop_multi_bls12381_from_hex(TESTVEC_MULTI_BLS12_381_4_POP);
