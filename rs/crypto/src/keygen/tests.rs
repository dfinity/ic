...
mod key_counts {
    ...
    fn should_collect_correctly_key_count_metrics_for_all_keys() {
        ...
        assert_eq!(ALL_KEYS_PRESENT, key_counts.get_pk_registry());
        assert_eq!(ALL_KEYS_PRESENT, key_counts.get_pk_local());
        assert_eq!(ALL_KEYS_PRESENT, key_counts.get_sk_local());
    ...
    fn should_count_correctly_inconsistent_numbers_of_node_signing_keys() {
        ...
        assert_eq!(ALL_KEYS_PRESENT, key_counts.get_pk_registry());
        assert_eq!(ALL_KEYS_PRESENT, key_counts.get_pk_local());
        assert_eq!(ALL_KEYS_PRESENT - 1, key_counts.get_sk_local());
        assert_eq!(1, key_counts.get_idkg_pks_local());
    }
