...
fn with_random_duplicates(
    ...
    for _ in 0..n {
        let in_index = rng.r#gen_range(0..sigs.len());
        let out_index = rng.r#gen_range(0..result_sigs.len() + 1);
...
fn with_random_sigs_of_existing_messages_signed_by_existing_signers(
    ...
    let mut result_msgs = msgs.to_vec();
    for _ in 0..n {
        let msg_index = rng.r#gen_range(0..sigs.len());
        let signer_index = rng.r#gen_range(0..sigs.len());
