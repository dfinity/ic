...
impl EccPoint {
    ...
    pub fn generator_g(curve: EccCurveType) -> Self {
        match curve {
            EccCurveType::K256 => secp256k1::Point::generator().into(),
            EccCurveType::P256 => secp256r1::Point::generator().into(),
        }
    }
    ...
    pub fn generator_h(curve: EccCurveType) -> Self {
        ...
        */
        ...
        Self::deserialize(curve, &h).expect("generator_h is not valid")
    }
