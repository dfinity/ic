...
use crate::server::remote_csp_server::tarpc_client::RemoteCspVault;
use crate::server::remote_csp_server::tarpc_csp_server;
...
fn start_new_csp_server() -> PathBuf {
    ...
    let server = tarpc_csp_server::TarpcCspVaultServerImpl::new(sks_dir.path(), &socket_path);
