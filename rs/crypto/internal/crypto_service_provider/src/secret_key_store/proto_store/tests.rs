    ...
    fn tls() -> TestVector {
        TestVector {
            ...
            secret_key: CspSecretKey::TlsEd25519(TlsEd25519SecretKeyDerBytes {
                bytes: [
                    48, 46, 2, 1, 0, 48, 5, 6, 3, 43, 101, 112, 4, 34, 4, 32, 155, 183, 227, 248,
                    2, 202, 222, 165, 100, 242, 173, 163, 239, 23, 85, 16, 84, 8, 182, 46, 199, 93,
                    167, 71, 223, 94, 157, 198, 73, 52, 6, 130,
                ]
                .to_vec(),
            }),
        }
