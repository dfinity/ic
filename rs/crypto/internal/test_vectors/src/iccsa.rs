    ...
    match id {
        TestVectorId::STABILITY_1 => {
            ...
            TestVector {
                ...
                root_pubkey_der: base64::decode(&"MIGCMB0GDSsGAQQBgtx8BQMBAgEGDCsGAQQBgtx8BQMCAQNhAJN9lndC9PmwG44m08nlPFolGoNYavxz8FS6wa7WDBsR56ZnfsCyYIXNwdOa1MjctQLtFPVK9EDR2CkHWx6fbnLeV+uyOEphXQs+Lzpq9FFlMt5xOipXRXpmtosKfTT4Tg==").unwrap(),
            }
        }
    }
}
