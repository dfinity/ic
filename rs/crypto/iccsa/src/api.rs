...
use ic_crypto_internal_basic_sig_der_utils::{PkixAlgorithmIdentifier, parse_public_key};
...
pub fn public_key_bytes_from_der(pk_der: &[u8]) -> CryptoResult<PublicKeyBytes> {
    let algorithm_identifier = PkixAlgorithmIdentifier::new_with_empty_param(
