...
const TAG_FILE_INFO_RELATIVE_PATH: [u8; 1] = [0x0a_u8];
const TAG_FILE_INFO_SIZE_BYTES: [u8; 1] = [0x10_u8];
const TAG_FILE_INFO_HASH: [u8; 1] = [0x1a_u8];

const TAG_CHUNK_INFO_FILE_INDEX: [u8; 1] = [0x08_u8];
const TAG_CHUNK_INFO_SIZE_BYTES: [u8; 1] = [0x10_u8];
const TAG_CHUNK_INFO_OFFSET: [u8; 1] = [0x18_u8];
const TAG_CHUNK_INFO_HASH: [u8; 1] = [0x22_u8];

const TAG_MANIFEST_VERSION: [u8; 1] = [0x08_u8];
const TAG_MANIFEST_FILE_INFO: [u8; 1] = [0x12_u8];
const TAG_MANIFEST_CHUNK_INFO: [u8; 1] = [0x1a_u8];
