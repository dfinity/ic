...
fn expected_subnet_1_system_metadata() -> (FileInfo, ChunkInfo) {
    (
        FileInfo {
            ...
            size_bytes: 68,
            hash: [
                78, 238, 78, 17, 184, 53, 165, 62, 217, 51, 114, 244, 68, 143, 232, 32, 90, 63, 45,
                134, 51, 144, 248, 106, 212, 211, 58, 23, 10, 95, 146, 65,
            ],
        },
        ChunkInfo {
            file_index: 13,
            ...
            offset: 0,
            hash: [
                13, 106, 85, 104, 0, 31, 105, 192, 113, 124, 153, 142, 236, 229, 176, 163, 16, 20,
                52, 79, 170, 36, 197, 189, 52, 66, 254, 27, 85, 81, 135, 44,
            ],
        },
    )
}
