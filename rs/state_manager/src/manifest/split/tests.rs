...
fn expected_subnet_1_system_metadata() -> (FileInfo, ChunkInfo) {
    (
        FileInfo {
            ...
            size_bytes: 82,
            hash: [
                101, 247, 211, 218, 207, 84, 174, 38, 246, 71, 44, 160, 187, 150, 99, 57, 250, 97,
                98, 86, 102, 7, 186, 141, 62, 22, 128, 82, 33, 163, 206, 192,
            ],
        },
        ChunkInfo {
            file_index: 5,
            ...
            offset: 0,
            hash: [
                82, 63, 56, 50, 123, 173, 121, 81, 236, 182, 203, 12, 167, 112, 6, 174, 225, 22,
                188, 27, 39, 192, 9, 235, 17, 253, 131, 251, 209, 69, 53, 168,
            ],
        },
    )
}
