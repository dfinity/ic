...
fn expected_subnet_1_system_metadata() -> (FileInfo, ChunkInfo) {
    (
        FileInfo {
            ...
            size_bytes: 65,
            hash: [
                97, 210, 146, 68, 4, 167, 118, 6, 122, 32, 179, 35, 138, 228, 65, 241, 239, 163,
                44, 181, 162, 251, 86, 207, 20, 62, 202, 181, 81, 219, 172, 36,
            ],
        },
        ChunkInfo {
            file_index: 13,
            ...
            offset: 0,
            hash: [
                118, 79, 236, 195, 6, 107, 254, 27, 184, 117, 222, 166, 67, 249, 149, 61, 103, 206,
                25, 94, 40, 72, 234, 150, 230, 223, 122, 6, 164, 19, 40, 48,
            ],
        },
    )
}
