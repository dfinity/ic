...
pub struct StateSyncRefs {
    ...
    chunks_of_incomplete_state:
        Arc<parking_lot::RwLock<BTreeMap<Height, (PathBuf, HashSet<ChunkId>)>>>,
}
...
impl StateSyncRefs {
    fn new(log: ReplicaLogger) -> Self {
        Self {
            ...
            chunks_of_incomplete_state: Arc::new(parking_lot::RwLock::new(BTreeMap::new())),
        }
    }
}
