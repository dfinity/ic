...
To verify the build reproducibility of a specific proposal, you can just copy the one liner below to a fresh Ubuntu VM 22.04 or higher:
...
All code of the Internet Computer is licensed under the Apache 2.0 license, except for a
