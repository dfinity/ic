...
incident). It also catches the second case within seconds instead of after a
multi-hour build.

Consequently:

* An attestation that *does not match* aborts the run.
