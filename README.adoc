...
few components licensed under the [Internet Computer Community
Source License](licenses/IC-1.0.txt) and [Internet Computer Shared Community Source License](licenses/IC-shared-1.0.txt) which are more restrictive than the Apache 2.0 license to protect the Intellectual Property (IP) of the DFINITY Foundation.
